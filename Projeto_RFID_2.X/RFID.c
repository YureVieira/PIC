 ...
 * 
 */
const __FlashStringHelper *GetStatusCodeName(unsigned char code	///< One of the StatusCode enums.
										) {
	switch (code) {
 ...
 * 
 */
const __FlashStringHelper *PICC_GetTypeName(unsigned char piccType	///< One of the PICC_Type enums.
										) {
	switch (piccType) {
